...
/**
 * Created by chenMeng on 2018/1/10.
 */
...
public class GuideView extends RelativeLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private int drawTopPos = 0;
    private int drawBottomPos = 0;
    ...
    private void drawBackground(Canvas canvas) {
        ...
        if (myShape != null) {
            ...
            switch (myShape) {
                case CIRCULAR://圆形
                    drawTopPos = center[1]-targetView.getHeight();
                    drawBottomPos = center[1]+targetView.getHeight();
                ...
                case ELLIPSE://椭圆
                    ...
                    oval.top = drawTopPos;          //上边
                    oval.right = center[0] + targetView.getWidth() / 2 ;     //右边
                    oval.bottom = drawBottomPos;       //下边
        ...
        setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_UP) {
                    if (y>=drawTopPos && y<=drawBottomPos){
