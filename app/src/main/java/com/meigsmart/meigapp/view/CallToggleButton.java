...
/**
 * Created by chenMeng on 2017/9/29.
 */
public class CallToggleButton extends View {

    private static final String tag = CallToggleButton.class.getSimpleName();
    ...
    private Bitmap leftBt;//左侧接听图片
    private Bitmap rightBt;//右侧挂断图片
    ...
    private void drawLeftCircleButton(Canvas canvas, Paint paint) {
        ...
        if (circleOffset < initialCircleOffset) {
            alpha = 255 - (int) (255 - ((float) 255 / (float) initialCircleOffset) * circleOffset);
            if (alpha <= 0) {
                alpha = 0;
            }
        }
        ...
        //画最左边的字体
        canvas.drawBitmap(leftBt,circleMargin*2,circleMargin*2, paint);
    }
    ...
    private void drawRightCircleButton(Canvas canvas, Paint paint) {
        ...
        //画最右边的字体
        canvas.drawBitmap(rightBt,width - height / 2-circleMargin*3,circleMargin*2, paint);
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            textSize = typedArray.getDimensionPixelSize(R.styleable.CallSliderView_CallSliderView_textSize, 30);
            progressBackgroundColor = typedArray.getColor(R.styleable.CallSliderView_CallSliderView_progressBackgroundColor, Color.RED);
            backgroundColor = typedArray.getColor(R.styleable.CallSliderView_CallSliderView_backgroundColor, 0x0fffffff);
            sliderText = typedArray.getString(R.styleable.CallSliderView_CallSliderView_text);
            leftColor = typedArray.getColor(R.styleable.CallSliderView_CallSliderView_Left_BackgroundColor, Color.GREEN);
            rightColor = typedArray.getColor(R.styleable.CallSliderView_CallSliderView_Right_BackgroundColor, Color.RED);
        ...
        leftBt = ((BitmapDrawable)context.getResources().getDrawable(R.drawable.ic_call)).getBitmap();
        rightBt = ((BitmapDrawable)context.getResources().getDrawable(R.drawable.ic_call_end)).getBitmap();
    }
}
