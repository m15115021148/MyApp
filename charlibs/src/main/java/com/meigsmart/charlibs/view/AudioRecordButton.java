package com.meigsmart.charlibs.view;
...
import com.meigsmart.charlibs.util.AudioManager;
import com.meigsmart.charlibs.util.PathUtils;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case AudioManager.MSG_ERROR_AUDIO_RECORD:
                    Toast.makeText(getContext().getApplicationContext(), R.string.result,
