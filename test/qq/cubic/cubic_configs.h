...
#define CUBIC_CFG_loc_static_hold_speed             "rw.location.static_hold_speed"    // cm/s
#define CUBIC_CFG_loc_static_hold_distance          "rw.location.static_hold_distance" // metre
...
#define CUBIC_CFG_net_apn_protocol                  CUBIC_CFG_net_apn".%s.protocol"          //The protocol. Must be either 0:IPV4  1:PPP  2:IPV6  3:IPV4&IPV6
...
#define CUBIC_CFG_update_connect_timeout            "rw.update.connect_timeout"
#define CUBIC_CFG_update_max_transmit_time          "rw.update.max_transmit_time"
#define CUBIC_CFG_update_max_file_size              "rw.update.max_file_size"

#define CUBIC_CFG_evt_sleep_timeout                 "rw.evt.sleep_timeout"   // timeout of event in seconds, when reach, device will try to get in sleep, 0~65535

#define CUBIC_CFG_pwr_sleep_mode                    "rw.pwr.sleep_mode"      // sleep mode, "none" never sleep, "standby" sleep when idle status, "sleepy" sleep if no communication
#define CUBIC_CFG_pwr_sleep_period                  "rw.pwr.sleep_period"    // sleep period in seconds, set the period of each sleep step
