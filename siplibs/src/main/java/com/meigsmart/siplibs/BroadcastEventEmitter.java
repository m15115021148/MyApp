...
public class BroadcastEventEmitter {
    ...
    public void onMessageNotify(String accountID, String fromUri, String msg){
        ...
        intent.setAction(getAction(BroadcastAction.MESSAGE_NOTIFY));
        intent.putExtra(BroadcastParameters.ACCOUNT_ID, accountID);
        intent.putExtra(BroadcastParameters.FROM_URI, fromUri);
        intent.putExtra(BroadcastParameters.MESSAGE_BODY, msg);
        intent.addFlags(Intent.FLAG_RECEIVER_FOREGROUND);
