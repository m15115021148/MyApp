...
public class SipAccount extends Account {
    ...
    public SipCall addOutgoingCall(String numberToDial) {
        ...
        try {
            if (numberToDial.startsWith("sip:")) {
                ...
                call.makeCall("sip:" + numberToDial + "@" + data.getDomain(), callOpParam);
            }
    ...
    public void onInstantMessage(OnInstantMessageParam prm) {
        try {
            service.getBroadcastEmitter().onMessageNotify(
                    data.getIdUri(),prm.getFromUri(),prm.getMsgBody()
            );
        }catch (Exception e){
            e.printStackTrace();
        }
