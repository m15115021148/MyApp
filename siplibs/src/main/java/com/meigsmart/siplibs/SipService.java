...
import static com.meigsmart.siplibs.SipServiceCommand.ACTION_ACCEPT_INCOMING_CALL;
import static com.meigsmart.siplibs.SipServiceCommand.ACTION_DECLINE_INCOMING_CALL;
import static com.meigsmart.siplibs.SipServiceCommand.ACTION_GET_CALL_STATUS;
import static com.meigsmart.siplibs.SipServiceCommand.ACTION_GET_CODEC_PRIORITIES;
import static com.meigsmart.siplibs.SipServiceCommand.ACTION_GET_REGISTRATION_STATUS;
import static com.meigsmart.siplibs.SipServiceCommand.ACTION_HANDLE_NET_WORK_CHANGE;
import static com.meigsmart.siplibs.SipServiceCommand.ACTION_HANG_UP_CALL;
import static com.meigsmart.siplibs.SipServiceCommand.ACTION_HANG_UP_CALLS;
import static com.meigsmart.siplibs.SipServiceCommand.ACTION_HOLD_CALLS;
import static com.meigsmart.siplibs.SipServiceCommand.ACTION_MAKE_CALL;
import static com.meigsmart.siplibs.SipServiceCommand.ACTION_REMOVE_ACCOUNT;
import static com.meigsmart.siplibs.SipServiceCommand.ACTION_RESTART_SIP_STACK;
import static com.meigsmart.siplibs.SipServiceCommand.ACTION_SEND_DTMF;
import static com.meigsmart.siplibs.SipServiceCommand.ACTION_SEND_MESSAGE;
import static com.meigsmart.siplibs.SipServiceCommand.ACTION_SET_ACCOUNT;
import static com.meigsmart.siplibs.SipServiceCommand.ACTION_SET_CODEC_PRIORITIES;
import static com.meigsmart.siplibs.SipServiceCommand.ACTION_SET_HOLD;
import static com.meigsmart.siplibs.SipServiceCommand.ACTION_SET_MUTE;
import static com.meigsmart.siplibs.SipServiceCommand.ACTION_TOGGLE_HOLD;
import static com.meigsmart.siplibs.SipServiceCommand.ACTION_TOGGLE_MUTE;
import static com.meigsmart.siplibs.SipServiceCommand.ACTION_TRANSFER_CALL;
import static com.meigsmart.siplibs.SipServiceCommand.AGENT_NAME;
import static com.meigsmart.siplibs.SipServiceCommand.PARAM_ACCOUNT_DATA;
import static com.meigsmart.siplibs.SipServiceCommand.PARAM_ACCOUNT_ID;
import static com.meigsmart.siplibs.SipServiceCommand.PARAM_CALL_ID;
import static com.meigsmart.siplibs.SipServiceCommand.PARAM_CODEC_PRIORITIES;
import static com.meigsmart.siplibs.SipServiceCommand.PARAM_DTMF;
import static com.meigsmart.siplibs.SipServiceCommand.PARAM_HOLD;
import static com.meigsmart.siplibs.SipServiceCommand.PARAM_MUTE;
import static com.meigsmart.siplibs.SipServiceCommand.PARAM_NUMBER;
import static com.meigsmart.siplibs.SipServiceCommand.PARAM_REMOTEURI;
import static com.meigsmart.siplibs.SipServiceCommand.PARAM_SEND_MESSAGE;
...
public class SipService extends BackgroundService {
    ...
    private static final int LOG_LEVEL = 3;//log level default 3  max 6
...
//                addAllConfiguredAccounts();
    ...
    public int onStartCommand(final Intent intent, int flags, int startId) {
        enqueueJob(new Runnable() {
            ...
            public void run() {
                ...
                } else if (ACTION_HANDLE_NET_WORK_CHANGE.equals(action)){
                    handleNetworkChange();
    ...
    private void handleSendMessage(Intent intent){
        String accountID = intent.getStringExtra(PARAM_ACCOUNT_ID);
        String sendMessage = intent.getStringExtra(PARAM_SEND_MESSAGE);
        String remoteUri = intent.getStringExtra(PARAM_REMOTEURI);

        SipAccount account = mActiveSipAccounts.get(accountID);
        if (account == null) return;

        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("<").append(remoteUri).append(";transport=tcp>");
        Log.e("pjsipSendMsg","buddy_uri =>" + stringBuilder.toString());
        BuddyConfig bCfg = new BuddyConfig();
        bCfg.setUri(stringBuilder.toString());
        bCfg.setSubscribe(false);

        Buddy myBuddy = new Buddy();

        SendInstantMessageParam prm = new SendInstantMessageParam();
        prm.setContent(sendMessage);
        try {
    ...
    private void startStack() {
        ...
        if (logWriter == null)logWriter = new SipLogWriter();
