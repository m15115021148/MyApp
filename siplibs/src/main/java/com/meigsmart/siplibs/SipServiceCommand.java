...
public class SipServiceCommand {
    ...
    protected static final String ACTION_HANDLE_NET_WORK_CHANGE = "handleNetWorkChange";
    ...
    protected static final String PARAM_SEND_MESSAGE = "msg";
    protected static final String PARAM_REMOTEURI = "remoteUri";
    ...
    public static void hangUpActiveCalls(Context context, String accountID) {
        Log.e("result","hangUpActiveCalls:->"+accountID);
        checkAccount(accountID);
    ...
    public static void netWorkChange(Context context){
        Intent intent = new Intent(context, SipService.class);
        intent.setAction(ACTION_HANDLE_NET_WORK_CHANGE);
        context.startService(intent);
    }

    public static void sendMessage(Context context, String accountID ,String msg,String remoteUri){
        checkAccount(accountID);

        Intent intent = new Intent(context, SipService.class);
        intent.setAction(ACTION_SEND_MESSAGE);
        intent.putExtra(PARAM_ACCOUNT_ID, accountID);
        intent.putExtra(PARAM_SEND_MESSAGE,msg);
        intent.putExtra(PARAM_REMOTEURI,remoteUri);
        context.startService(intent);
    }
}
